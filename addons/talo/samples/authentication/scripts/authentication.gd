...
func _configure_signals():
	login.verification_required.connect(
		func():
			_make_state_visible(verify),
	)
	login.go_to_forgot_password.connect(
		func():
			_make_state_visible(forgot_password),
	)
	login.go_to_register.connect(
		func():
			_make_state_visible(register),
	)
	...
	in_game.go_to_change_password.connect(
		func():
			_make_state_visible(change_password),
	)
	in_game.go_to_change_email.connect(
		func():
			_make_state_visible(change_email),
	)
	in_game.go_to_change_identifier.connect(
		func():
			_make_state_visible(change_identifier),
	)
	in_game.go_to_delete.connect(
		func():
			_make_state_visible(delete_account),
	)
	in_game.logout_success.connect(
		func():
			_make_state_visible(login),
	)

	change_password.password_change_success.connect(
		func():
			_make_state_visible(in_game),
	)
	change_password.go_to_game.connect(
		func():
			_make_state_visible(in_game),
	)

	change_email.email_change_success.connect(
		func():
			_make_state_visible(in_game),
	)
	change_email.go_to_game.connect(
		func():
			_make_state_visible(in_game),
	)

	change_identifier.identifier_change_success.connect(
		func():
			_make_state_visible(in_game),
	)
	change_identifier.go_to_game.connect(
		func():
			_make_state_visible(in_game),
	)
	...
	forgot_password.forgot_password_success.connect(
		func():
			_make_state_visible(reset_password),
	)
	...
	delete_account.go_to_game.connect(
		func():
			_make_state_visible(in_game),
	)

	Talo.players.identified.connect(
		func(_player_alias: TaloPlayerAlias):
			_make_state_visible(in_game),
	)
