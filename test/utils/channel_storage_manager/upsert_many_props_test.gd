...
func test_upsert_many_props_adds_all_props() -> void:
	...
	manager.upsert_many_props(
		1,
		[
			TaloFixtures.make_channel_storage_prop(
				{ "channel_storage_prop": { "key": "color", "value": "red" } }
			),
			TaloFixtures.make_channel_storage_prop(
				{ "channel_storage_prop": { "key": "size", "value": "large" } }
			),
		],
	)
...
func test_upsert_many_props_replaces_existing_props() -> void:
	...
	manager.upsert_many_props(
		...
		[
			TaloFixtures.make_channel_storage_prop(
				{ "channel_storage_prop": { "key": "color", "value": "blue" } }
			),
			TaloFixtures.make_channel_storage_prop(
				{ "channel_storage_prop": { "key": "size", "value": "small" } }
			),
		],
	)
...
func test_upsert_many_props_stores_array_props_as_individual_entries() -> void:
	...
	manager.upsert_many_props(
		...
		[
			TaloFixtures.make_channel_storage_prop(
				{ "channel_storage_prop": { "key": "items[]", "value": "sword" } }
			),
			TaloFixtures.make_channel_storage_prop(
				{ "channel_storage_prop": { "key": "items[]", "value": "shield" } }
			),
			TaloFixtures.make_channel_storage_prop(
				{ "channel_storage_prop": { "key": "color", "value": "red" } }
			),
